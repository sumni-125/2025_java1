...
class Acorn {
	...
	//getter 규칙		get속성명()	,	속성명의 첫 글자는대문자 규칙
	...
	//객체생성과 상관없이 바로 사용할 수 있는 변수를 사용하는것은 당연하다.
	...
	//매서드 작성시
	//static 여부 결정하는 기준은
	//인스턴스 변수의 사용 유무 => 사용한다면 인스턴스 매서드 만들어야 한다(필수)
	//					 => 사용 안한다면 static매서드로 만들 수 있다 (선택)
...
public class 클래스변수활용 {
	...
	public static void main(String[] args) {
		...
		Acorn acorn1 = new Acorn("딸기", "1234", "박시우");	//constructor? 생성자
